...
class ConnectionManager:
    ...
    async def broadcast_to_game(self, game_id: int, message: dict, exclude: WebSocket = None):
    ...
    async def send_phase_change(self, game_id: int, phase: str, phase_end_time: str = None):
    ...
    async def send_player_revealed_card(self, game_id: int, player_id: int, player_name: str, card_type: str, card_value: str = None):
    ...
    async def send_special_card_used(self, game_id: int, player_name: str, special_name: str):
