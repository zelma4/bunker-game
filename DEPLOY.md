...
## 🌐 Є домен? → [DOMAIN_SETUP.md](DOMAIN_SETUP.md)
Якщо у тебе є домен (наприклад, `bunker.zelma4.me`), перейди до **DOMAIN_SETUP.md** для повної інструкції з налаштування HTTPS.
